...
) TABLESPACE seriespace ROW_FORMAT=COMPACT;
ALTER TABLE serie AUTO_INCREMENT=1000;

CREATE TABLE IF NOT EXISTS titel (
    id          INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
    titel       VARCHAR(40) NOT NULL,
    untertitel  VARCHAR(40),
    serie_id     INT UNIQUE NOT NULL references serie(id)
) TABLESPACE seriespace ROW_FORMAT=COMPACT;
...
CREATE TABLE IF NOT EXISTS abbildung (
    ...
    INDEX abbildung_serie_id_idx(serie_id)
) TABLESPACE seriespace ROW_FORMAT=COMPACT;
...
ALTER TABLE serie_file AUTO_INCREMENT=1000;
