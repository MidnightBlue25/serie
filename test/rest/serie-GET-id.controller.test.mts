...
describe('GET /rest/:id', () => {
    ...
    test.concurrent('Serie zu vorhandener ID', async () => {
        ...
        // when
        const { status, headers, data }: AxiosResponse<Serie> =
    ...
    test.concurrent('Keine Serie zu nicht-vorhandener ID', async () => {
        // given
    ...
    test.concurrent('Keine Serie zu falscher ID', async () => {
        // given
        const url = `/${idFalsch}`;
    ...
    test.concurrent('Serie zu vorhandener ID mit ETag', async () => {
        // given
