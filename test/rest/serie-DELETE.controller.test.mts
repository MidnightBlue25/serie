...
describe('DELETE /rest', () => {
    ...
    test.concurrent('Vorhandenes Serie loeschen', async () => {
        // given
        const url = `/${id}`;
    ...
    test.concurrent('Serie loeschen, aber ohne Token', async () => {
        // given
        const url = `/${id}`;
    ...
    test.concurrent('Serie loeschen, aber mit falschem Token', async () => {
        // given
        const url = `/${id}`;
        const token = 'FALSCH';
        const headers: Record<string, string> = {
    ...
    test.concurrent('Vorhandene Serie als "user" loeschen', async () => {
        // given
        const url = `/60`;
        const headers: Record<string, string> = {
